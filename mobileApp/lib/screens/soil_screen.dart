  ...
  Future<void> _pickImage() async {
    ...
    if (picked != null) {
      setState(() {
        ...
        _description = "🧪 Based on image: Soil likely shows signs of nutrient deficiency (simulated)";
      });
    }
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const Divider(),
            const Text('🧾 Answer Questionnaire', style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
